...
export default function CTASection() {
  ...
  return (
    ...
    >
      <div>
        <motion.h1
          className="text-4xl md:text-[46px] md:leading-[60px] font-semibold bg-gradient-to-r from-white to-pink-400 text-transparent bg-clip-text"
        ...
        <motion.p
          className="bg-gradient-to-r from-white to-pink-400 text-transparent bg-clip-text text-lg"
          initial={{ y: 80, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true }}
